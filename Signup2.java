...
public class Signup2 extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            Conn c1 = new Conn();
            String q1 = "insert into signup2 values('"+form_number+"','"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+pan+"','"+aadhar+"','"+senior_citizen+"','"+existing_account+"')";
