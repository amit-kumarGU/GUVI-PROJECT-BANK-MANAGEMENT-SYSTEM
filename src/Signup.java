...
public class Signup extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(name.equals("") || father_name.equals("") || dob.equals("") || gender == null ||
        ...
        if(!city.matches("[A-Za-z ]+")){
            JOptionPane.showMessageDialog(null, "City should contain only alphabets!");
            return;
        }

        if(!state.matches("[A-Za-z ]+")){
            JOptionPane.showMessageDialog(null, "State should contain only alphabets!");
            return;
        }
        ...
        try {
            Conn c1 = new Conn();
            String q1 = "insert into signup values('" + form_number + "','" + name + "','" + father_name + "','" + dob + "','" + gender + "','" + email + "','" + marital + "','" + address + "','" + city + "','" + pincode + "','" + state + "')";
